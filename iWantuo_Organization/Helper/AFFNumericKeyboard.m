...
#define kLineWidth 1
#define kF  [UIScreen mainScreen].bounds.size.width/320
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.bounds = CGRectMake(0, 0, kScreenBoundWidth, 216);
        //
        ...
        //
        UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(105*kF, 0, kLineWidth, 216)];
        line1.backgroundColor = color;
        [self addSubview:line1];
        
        UIView *line2 = [[UIView alloc] initWithFrame:CGRectMake(214*kF, 0, kLineWidth, 216)];
        line2.backgroundColor = color;
        [self addSubview:line2];
        
        for (int i=0; i<3; i++)
        {
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 54*(i+1), kScreenBoundWidth, kLineWidth)];
