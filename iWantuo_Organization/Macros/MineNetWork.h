...
#ifndef MineNetWork_h
#define MineNetWork_h
...
#define GrowCurveAction            @"trace/phoneSelectShow"  //成长曲线
#define kMineGrowAvgAction         @"trace/phoneSelectShowAverage" //学习表现行为每日平均值接口
